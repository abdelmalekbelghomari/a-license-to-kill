...
void display_citizen_information(WINDOW *window, memory_t *mem, int row, int column)
{
    ...
    number_of_citizens_at_home = mem->at_home_citizens; //mem->at_home_citizens; //128;
    number_of_citizens_at_work = mem->at_work_citizens;//mem->at_work_citizens; //0;
    number_of_citizens_walking = mem->walking_citizens;//mem->walking_citizens; //0;
   /* ---------------------------------------------------------------------- */
